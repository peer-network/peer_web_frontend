 ...
 * Author: Luqman
 * Dated: 29 April 2025
 * Usage: This template contains SVG symbol definitions used throughout the site. 
 * The symbols are used for various icon elements such as post comment, like, view and multi-chat icons.
 * These symbols will be included in the header of the page and can be referenced anywhere within the site for efficient reuse.
 * The file helps in reducing repeated SVG markup by centralizing SVG definitions and referencing them via <use> tags.
 * 
 * This file is utilized not only in the private chat page but also in the dashboard and will be used in other modules as well.
 */
?>
